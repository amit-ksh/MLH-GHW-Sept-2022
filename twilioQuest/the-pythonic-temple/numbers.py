...
print(f"{first_number} plus {second_number} equals {result_difference}")
print(f"{first_number} plus {second_number} equals {result_product}")
print(f"{first_number} plus {second_number} equals {result_quotient}")
