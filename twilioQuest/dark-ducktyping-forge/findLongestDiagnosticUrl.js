function findLongestDiagnosticUrl(reservoirs) {
  ...
  const diagnosticUrls = reservoirs.map((reservoir) => {
    ...
    reservoirDetailParams.set("rads", reservoir.radiation && reservoir.radiation.radsCountCurrent || '0');
    reservoirDetailParams.set("guid", reservoir.radiation && reservoir.radiation.monitorSystemGuid);
